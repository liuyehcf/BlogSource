...
本硕都在北邮读的，专业是通信工程，然后在硕士阶段的业余时间自学的计算机。毕业之后，就职于阿里巴巴物联网IOT事业部，IOT事业部整体属性偏业务，涵盖的领域非常多，包括IOT平台，负责设备的连接、管理和赋能、边缘计算、AI、以及各种垂直行业线，包括工业、农业、园区、地产等等。我在里面主要负责偏Infra相关的工作，主要包括：隧道服务，提供访问私网设备服务的能力、规则中心，管理设备联动规则，以及边缘一体机系统镜像构建平台。细节不展开了，简历里面都有介绍。

在IOT这边干了3年多，正好赶上当时数据库比较火，运气比较好，就单纯依靠相对比较扎实的基础和热情，0基础跳槽去了一家数据库创业公司，我所在的团队是查询团队，主要负责SQL的优化和执行。我在这里主要的贡献涵盖了优化器、执行器以及可观测性这几个方面，包括执行引擎的重构迁移、各种算子优化包括Sort算子、Window算子、Exchange算子、参与优化器的迭代工作，包括支持更多类型的子查询、Plan枚举以及Profile相关的功能。
