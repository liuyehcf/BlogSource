...
```sh
nasm -f elf64 use_memory.asm -o use_memory.o
gcc -m64 use_memory.o -o use_memory
...
```sh
nasm -f elf64 use_memory2.asm -o use_memory2.o
gcc -m64 use_memory2.o -o use_memory2
