...
```sh
mkdir jni_best_practice
cd jni_best_practice

mkdir -p src
mkdir -p test/java/org/liuyehcf/jni
...
cat > test/java/org/liuyehcf/jni/MethodReturnType.java << 'EOF'
package org.liuyehcf.jni;

public class MethodReturnType {
    public static void staticVoidMethod() {}
    public static Object staticObjectMethod() { return null; }
    public static int[] staticArrayMethod() { return null; }
    public static boolean staticBooleanMethod() { return true; }
    public static byte staticByteMethod() { return 1; }
    public static char staticCharMethod() { return 2; }
    public static short staticShortMethod() { return 3; }
    public static int staticIntMethod() { return 4; }
    public static long staticLongMethod() { return 5; }
    public static float staticFloatMethod() { return 6; }
    public static double staticDoubleMethod() { return 7; }
    public void voidMethod() {}
    public Object objectMethod() { return null; }
    public Object[][] arrayMethod() { return null; }
    public boolean booleanMethod() { return true; }
    public byte byteMethod() { return 11; }
    public char charMethod() { return 12; }
    public short shortMethod() { return 13; }
    public int intMethod() { return 14; }
    public long longMethod() { return 15; }
    public float floatMethod() { return 16; }
    public double doubleMethod() { return 17; }
}
EOF

cat > test/java/org/liuyehcf/jni/ThrowException.java << 'EOF'
package org.liuyehcf.jni;
...
cmake -B build -DCMAKE_EXPORT_COMPILE_COMMANDS=ON && cmake --build build && CLASSPATH=build/classes build/jni_utils_test
```
