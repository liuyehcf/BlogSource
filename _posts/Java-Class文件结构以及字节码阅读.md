...
#### &emsp;&emsp;&emsp;&emsp;&emsp;1.2.1.1 那么什么是符号引用呢？
...
#### &emsp;&emsp;&emsp;&emsp;&emsp;1.2.1.2 为什么要使用符号引用呢？
...
### &emsp;&emsp;&emsp;1.5.1 概念解析：全限定名、简单名称、描述符
...
### &emsp;&emsp;&emsp;3.9.1 其他类型的条件分支
...
### &emsp;&emsp;&emsp;3.10.1 invokevirtual
...
### &emsp;&emsp;&emsp;3.10.2 invokeinterface
...
### &emsp;&emsp;&emsp;3.10.3 invokespecial
...
### &emsp;&emsp;&emsp;3.10.4 invokestatic
...
### &emsp;&emsp;&emsp;3.10.5 invokedynamic
...
### &emsp;&emsp;&emsp;4.1.3 for each循环
...
### &emsp;&emsp;&emsp;4.2.3 调用private方法
```Java
1 public class Test {
...
## &emsp;4.3 synchronized字节码分析

### &emsp;&emsp;&emsp;4.3.1 synchronized修饰的方法
```Java
1 public class Test {
...
### &emsp;&emsp;&emsp;4.3.2 synchronized块
