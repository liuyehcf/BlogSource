...
* [Parallel Sort-Merge Join](/resources/parallel-sort-merge-join.pdf)
...
* `Optimization Timing`
    * `Static Optimization`
        ...
        * `Plan`的质量取决于`Cardinality Estimation`以及`Cost Model`的准确性
            * [How-Good-Are-Query-Optimizers](/resources/How-Good-Are-Query-Optimizers.pdf)指出`Cardinality Estimation`的准确性更重要
...
* `Rule`：将一个`Expression`转换成另一个等价的`Expression`
    ...
    * ![20-1](/images/CMU-15-721/20-1.png)
...
* `MemSQL Optimizer`
    ...
    * ![20-2](/images/CMU-15-721/20-2.png)
...
* `Plan Pivot Points`
    ...
    * 方法包括
        * `Parametric Optimization`
            * ![21-1](/images/CMU-15-721/21-1.png)
...
* `Magnetoresistive RAM, MRAM`
    ...
    * ![25-4](/images/CMU-15-721/25-4.png)
...
1. [17-hash-joins](/resources/CMU-15-721/17-hash-joins.pdf)
1. [18-sort-merge-joins](/resources/CMU-15-721/18-sort-merge-joins.pdf)
...
1. [22-cost-models](/resources/CMU-15-721/22-cost-models.pdf)
1. [23-larger-than-memory](/resources/CMU-15-721/23-larger-than-memory.pdf)
