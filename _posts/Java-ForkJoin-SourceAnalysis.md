---
title: Java-ForkJoin-SourceAnalysis
...
![fig1](/images/Java-ForkJoin-SourceAnalysis/fig1.png)

## 1.1 工作窃取算法

工作窃取（work-stealing）算法是指某个线程从其他队列里窃取任务来执行。工作窃取的运行流程图如下：

![fig2](/images/Java-ForkJoin-SourceAnalysis/fig2.png)
...
![fig3](/images/Java-ForkJoin-SourceAnalysis/fig3.png)
