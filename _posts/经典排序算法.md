...
归并排序还有一个优化版本TimSort，关于TimSort的实现可以参考JDK Arrays.sort的源码 {% post_link ComparableTimSort-源码剖析 %}
...
关于双轴快排的更多实现可以参考JDK Arrays.sort的源码 {% post_link DualPivotQuickSort-源码剖析 %}
