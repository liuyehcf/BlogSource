---
title: SystemArchitecture-Register
...
![flag_register_1](/images/SystemArchitecture-Register/flag_register_1.jpg)
...
![segment_register_1](/images/SystemArchitecture-Register/segment_register_1.jpg)
...
![segment_register_2](/images/SystemArchitecture-Register/segment_register_2.jpg)
...
![segment_register_3](/images/SystemArchitecture-Register/segment_register_3.jpg)

**通用寄存器、段寄存器、标志寄存器、指令寄存器，这四组寄存器共同构成了一个基本的指令执行环境，一个线程的上下文也基本上就是这些寄存器，在执行线程切换的时候，就是修改它们的内容**

![segment_register_4](/images/SystemArchitecture-Register/segment_register_4.jpg)
...
![control_register_1](/images/SystemArchitecture-Register/control_register_1.jpg)
...
![debug_register_1](/images/SystemArchitecture-Register/debug_register_1.jpg)

![debug_register_2](/images/SystemArchitecture-Register/debug_register_2.jpg)
...
![debug_register_3](/images/SystemArchitecture-Register/debug_register_3.jpg)
...
![des_register_1](/images/SystemArchitecture-Register/des_register_1.jpg)

`GDT`和`LDT`中的表项，就是段描述符，描述了一个内存分段的信息，其结构如下：

![des_register_2](/images/SystemArchitecture-Register/des_register_2.jpg)
...
![des_register_3](/images/SystemArchitecture-Register/des_register_3.jpg)
...
![des_register_4](/images/SystemArchitecture-Register/des_register_4.jpg)
...
![task_register_1](/images/SystemArchitecture-Register/task_register_1.jpg)

* 定义了描述任务的数据结构`TSS`，里面存储了一个任务的上下文（一系列寄存器的值），下图是一个32位CPU的TSS结构图：

![task_register_2](/images/SystemArchitecture-Register/task_register_2.jpg)
...
![task_register_3](/images/SystemArchitecture-Register/task_register_3.jpg)
