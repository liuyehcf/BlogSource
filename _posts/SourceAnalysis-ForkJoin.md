...
![fig1](/images/SourceAnalysis-ForkJoin/fig1.png)

## 1.1 工作窃取算法

工作窃取（work-stealing）算法是指某个线程从其他队列里窃取任务来执行。工作窃取的运行流程图如下：

![fig2](/images/SourceAnalysis-ForkJoin/fig2.png)
...
![fig3](/images/SourceAnalysis-ForkJoin/fig3.png)
