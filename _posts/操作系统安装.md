...
第二步：编写`kickstart`文件，路径为`/workspace/liuyehcf.ks`
...
#Root password
rootpw --iscrypted $1$ronvjitX$RHP1I8yeGGOjKvsxPYZ460
#Initial user
user liuyehcf --fullname "localhost" --iscrypted --password $1$gEMSUbqu$CQkPr4bYXHeiKBxFGy5jx1
...
skipx
%pre
mkdir -p /mnt/sysimage/custom
cp -a /run/install/repo/EFI/* /mnt/sysimage/custom
